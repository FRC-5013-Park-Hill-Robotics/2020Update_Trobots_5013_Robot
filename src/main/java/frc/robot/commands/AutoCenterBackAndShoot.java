...
public class AutoCenterBackAndShoot extends SequentialCommandGroup {
  /**
   * Creates a new AutoCenterBackAndShoot.
   */
  public AutoCenterBackAndShoot(Drivetrain drivetrain, Limelight limelight, Shooter shooter, Conveyor conveyor, Intake intake) {
