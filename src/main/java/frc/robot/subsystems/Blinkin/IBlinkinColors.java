 ...
 * Add your docs here.
 */
public interface IBlinkinColors {
    ...
    //public final static double WHITE = 1965; //97 1965 0.93 Solid Colors White - - Brightness
    public final static double  WHITE =  0.93; //Solid Colors White - - Brightness
